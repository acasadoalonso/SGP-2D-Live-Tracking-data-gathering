...
python3 ~/src/APRSsrc/push2ogn.py --AVX  True  	>>/tmp/push2ogn.$$.log 2>>/tmp/push2ogn.$$.err &
#python3 ~/src/APRSsrc/push2ogn.py --SPIDER True --SPOT True --INREACH True 	>>/tmp/push2ogn.$$.log 2>>/tmp/push2ogn.$$.err &
